...
mixin _$Result<T> {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(ResultError error) failure,
    required TResult Function(T data) success,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult Function(ResultError error)? failure,
...
abstract class Failure<T> extends Result<T> {
  const factory Failure({required final ResultError error}) = _$Failure<T>;
